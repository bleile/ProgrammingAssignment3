### function "best" in script best.R for hospital outcome data as Part 2 of ProgrammingAssignment3, C. Bleile
### the function reads in data from an unzipped folder under the working directory, subsets the data
### and returns the "best" hospital for the selected state and mortality category from (“heart attack”, 
### “heart failure”, or “pneumonia”)
## best function follows:

best <- function(state="NA", outcome="heart attack") {
